...
const Header = () => {
  ...
  const menuItems = (
    <>
      ...
      {user?.email ? (
        <>
          ...
          <li onClick={handleLogOut}>
            <NavLink className="bg-transparent " to="/">
              <button className="border px-4 py-2 border-primary bg-primary duration-200 rounded text-white ">
                Logout
              </button>
            </NavLink>
          </li>
        ...
        <li className="hover:text-theme-default">
          <NavLink className="bg-transparent" to="/login">
            <button className="border py-2 px-4 border-primary bg-primary duration-200 rounded text-white">
              Login
            </button>
          </NavLink>
        </li>
  ...
  return (
    <div className="relative z-50">
      <img
        src={bannerBg}
        className="absolute inset-0 object-cover w-full h-20"
        alt=""
      />
